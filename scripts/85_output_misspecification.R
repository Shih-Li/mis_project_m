...
blind_table_numeric <- data.frame(
  ...
  interpretation = c(
    "Fitted-span / residual-scale invariance",
    "Weak-detection case: limited deletion sensitivity",
    "Specificity after correct-model calibration"
  ),
...
invariance_tex <- c(
  ...
  paste0(
    ...
    "overall residual scale leaves the standardized MIS statistic invariant. ",
...
write_tex_table(
  ...
  caption = paste0(
    "MIS localisation at k/n = 2.5 percent for mechanisms with a ",
    "well-defined observation-level affected subset."
  ),
